...
pattern = r'<Link href="#processus" className="mb-5 md:mb-6 inline-flex items-center gap-3 px-5 py-2 rounded-full border border-white/20 bg-white/5 backdrop-blur-md text-white/90 text-\[13px\] md:text-\[14px\] font-medium hover:bg-white/10 hover:border-white/40 transition-all duration-300 w-fit">.*?Le premier écosystème intelligent pour l\'agriculture.*?<svg className="w-4 h-4 text-white/60 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth=\{2\.5\} d="M9 5l7 7-7 7" /></svg>\s*</Link>'
