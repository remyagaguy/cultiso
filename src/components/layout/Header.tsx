      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 z-50">
            ...
            <Link href="/register">
              <Button className="font-bold text-[13px] sm:text-[14px] px-4 sm:px-5 h-[34px] sm:h-[40px] !bg-[#0B5345] hover:!bg-[#073A30] !text-white border-none shadow-sm rounded-[6px] sm:rounded-[8px] flex items-center justify-center transition-all">
                S'inscrire
              </Button>
            </Link>
