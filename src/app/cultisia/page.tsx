...
export default function CultisiaChat() {
      ...
      <aside style={{ width: sidebarOpen ? 260 : 60 }} className="h-full bg-[#f9f8f6] flex flex-col flex-shrink-0 border-r border-gray-100 transition-all duration-300 ease-in-out">
        <div className={`flex items-center ${sidebarOpen ? "justify-between pl-5 pr-3" : "justify-center"} h-[64px]`}>
          <Link href="/" className="flex items-center gap-2.5 hover:opacity-75 transition-opacity">
            ...
            {sidebarOpen && <span className="font-unbounded font-bold text-[16px] text-[#052821]">Cultisia</span>}
          </Link>
          {sidebarOpen && (
        ...
        {messages.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center px-6 pb-16">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#0B5345] to-[#148f6c] flex items-center justify-center mb-6 shadow-xl shadow-[#0B5345]/10 border border-[#0B5345]/10">
              <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.9C15.5 4.9 17 3.5 19 2c1 2 2 4.5 2 8 0 5.5-4.5 10-10 10Z"/><path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/></svg>
            </div>
            <h1 className="font-unbounded text-3xl sm:text-[34px] font-bold text-[#052821] mb-3 text-center leading-tight tracking-tight">Bonjour, comment puis-je<br className="hidden sm:block" /> vous aider ?</h1>
            <p className="text-[15px] text-gray-400 mb-10 text-center font-medium">Votre agronome virtuel, propulsé par l&apos;IA</p>
            <div className="w-full max-w-2xl">{renderInputBar("Posez votre question à Cultisia...", true)}</div>
