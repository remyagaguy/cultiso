  ...
  return (
    <>
      <main className="flex-grow flex flex-col items-center">
        {/* --- 1. HERO SECTION --- */}
        <section className="relative w-full px-6 pt-[64px] pb-16 md:pt-[64px] lg:pt-[64px] lg:pb-24 flex items-center bg-[#052821] overflow-hidden">
          ...
          <div className="max-w-[1200px] w-full mx-auto relative z-20">
            <div className="max-w-[850px] flex flex-col items-start">
              <Link href="#processus" className="group mb-5 md:mb-6 inline-flex items-center gap-1.5 sm:gap-3 pr-2.5 sm:pr-5 pl-1 sm:pl-1.5 py-1 sm:py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-md hover:bg-white/10 hover:border-white/20 transition-all duration-300 w-fit max-w-full overflow-hidden">
              ...
              <div className="pt-0 md:pt-2 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                  ...
                  <div className="flex items-center gap-3 mt-1 sm:mt-0">
                    <div className="flex -space-x-2">
                      ...
                      <div className="w-[34px] h-[34px] rounded-full border-2 border-[#052821] bg-[#f59e0b] flex items-center justify-center text-[10px] font-bold text-white shadow-sm">TR</div>
                      <div className="w-[34px] h-[34px] rounded-full border-2 border-[#052821] bg-white/10 backdrop-blur-md flex items-center justify-center text-[11px] font-bold text-white shadow-sm">+</div>
                    </div>
