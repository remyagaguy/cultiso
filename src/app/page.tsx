          ...
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center max-w-[1000px] mx-auto mb-16 md:mb-20">
              <h2 className="text-[clamp(30px,4vw,48px)] font-unbounded font-bold text-[#052821] mb-6 tracking-[-0.02em] leading-[1.1]">
                L'improvisation ruine votre business <br className="hidden md:block" /> 
                <span className="bg-gradient-to-r from-gray-400 to-gray-300 bg-clip-text text-transparent">— Cultiso vous aide à le sécuriser.</span>
              </h2>
              <p className="text-[16px] md:text-[18px] text-gray-500 font-manrope max-w-3xl mx-auto leading-relaxed">
                Profitez d'outils conçus sur mesure et d'un processus étape par étape, allant de l'idée à la commercialisation, pour gérer et sécuriser chaque aspect de votre agrobusiness.
              </p>
            </div>
