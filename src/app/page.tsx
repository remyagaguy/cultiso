          ...
          <div className="max-w-[1200px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
              ...
              <div className="relative z-10 flex flex-col items-center text-center group cursor-default">
                ...
                <h4 className="font-bold text-[#052821] text-[18px] mb-2">Analyse de marché</h4>
                <p className="text-gray-600 text-[14px]">Repérez les meilleures opportunités d'investissement grâce à une analyse poussée des tendances du marché.</p>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center text-center group cursor-default">
                ...
                <h4 className="font-bold text-[#052821] text-[18px] mb-2">Rentabilité financière</h4>
                <p className="text-gray-600 text-[14px]">Évaluez vos besoins matériels et stimulez la rentabilité financière de vos projets avant même d'investir.</p>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center text-center group cursor-default">
                ...
                <h4 className="font-bold text-[#052821] text-[18px] mb-2">Recommandations techniques</h4>
                <p className="text-gray-600 text-[14px]">Produisez sans improvisation grâce à des itinéraires techniques éprouvés et adaptés à vos productions.</p>
              </div>

              {/* Step 4 */}
              <div className="relative z-10 flex flex-col items-center text-center group cursor-default">
                <div className="w-14 h-14 bg-[#052821] text-white rounded-xl flex items-center justify-center font-bold text-xl font-unbounded mb-6 shadow-md ring-4 ring-[#052821]/10">4</div>
                <h4 className="font-bold text-[#052821] text-[18px] mb-2">Vente & Commercialisation</h4>
                <p className="text-gray-600 text-[14px]">Sécurisez vos débouchés et vendez vos récoltes au meilleur prix possible sur les marchés les plus porteurs.</p>
              </div>
            </div>
          </div>
        </section>

        {/* --- 4.1 CULTISIA (VERT CLAIR) --- */}
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              ...
              <div className="w-full lg:w-[45%] flex flex-col items-start text-left z-10">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <span className="font-unbounded font-bold text-[#052821] text-lg tracking-tight">Cultisia</span>
                </div>
          ...
          <div className="max-w-[1200px] mx-auto">
            <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-20">
              ...
              <div className="w-full lg:w-[45%] flex flex-col items-start text-left z-10">
                <div className="flex items-center gap-2 mb-6">
                  <img src="/favicon.png" alt="Cultiso" className="w-10 h-10 object-contain" />
                  <span className="font-unbounded font-bold text-[#D35400] text-lg tracking-tight">Cultiplan</span>
                </div>
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 shadow-2xl shadow-[#052821]/10 w-full flex flex-col overflow-hidden">
                    ...
                    <div className="px-5 py-3 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-[#052821] to-[#0a4237]">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="w-7 h-7 rounded-full bg-white/20 text-white flex items-center justify-center text-[10px] font-bold">KA</div>
                      </div>
                    </div>
                    {/* Project Header */}
          ...
          <div className="max-w-[1200px] mx-auto">
            <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-20">
              ...
              <div className="w-full lg:w-[45%] flex flex-col items-start text-left z-10">
                <div className="flex items-center gap-2 mb-6">
                  <img src="/favicon.png" alt="Cultiso" className="w-10 h-10 object-contain" />
                  <span className="font-unbounded font-bold text-[#052821] text-lg tracking-tight">Cultishop</span>
                </div>
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 shadow-2xl shadow-[#052821]/10 w-full flex flex-col overflow-hidden">
                    ...
                    <div className="px-5 pt-4 pb-3">
                      <div className="bg-green-50/60 rounded-xl border border-green-200 p-4 relative overflow-hidden">
                        <div className="absolute top-0 right-0 bg-[#22c55e] text-white text-[8px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-bl-lg">Meilleure offre</div>
