...
pattern_trust = r'<div className="hidden sm:flex flex-col gap-1\.5 text-white/75 text-\[12\.5px\] font-medium">.*?</div>\s*</div>'

new_trust = '''<div className="hidden sm:flex items-center gap-3">
...
text = re.sub(pattern_trust, new_trust, text, flags=re.DOTALL)
